        ...
        >
            <div class="w-full md:w-4/12 px-4">
                ...
                >
                    ...
                    <a
                        href="https://mlab-studio.com" target="_blank"
            ...
            <div class="w-full md:w-8/12 px-4">
                ...
                >
                    <li>
                        <a
                            href="https://mlab-studio.com/about/" target="_blank"
                    ...
                    <li>
                        <a
                            href="https://mlab-studio.com/what-we-do/" target="_blank"
                            class="text-gray-700 hover:text-gray-900 text-sm font-semibold block py-1 px-3"
                        >
                            Services
                        </a>
                    ...
                    <li>
                        <a
                            href="https://mlab-studio.com/contact-us/" target="_blank"
                            class="text-gray-700 hover:text-gray-900 text-sm font-semibold block py-1 px-3"
                        >
                            Contact Us
                        </a>
